...
#   (572_771  第90R〜第98R は訳語のみの是正で行数不変)
#   +528     第99R  別セッションPR#13(bc56874)からの選択取り込み。
#            radio 系のキー単位追加100(radioprogramojn/radio-elsendojn 等)、
#            hongkong 67 / reprezent 45 / sam 45 / nederland 40 / kore 40 / premi 40 /
#            ĉin 40 / mult 30 / dek 30 / miks 30 / apud 30 / fukuwarai 2 / 人名1。
#            ★mukoz 族のパディング付与12キーは**取り込まなかった**(submukozo が
#              sub[下に]muk[粘液]oz[膜]o に退行するため。第94Rの判定を踏襲)ので、
#              その分は行数に影響しない(PR側も同キーの置き換えで総数不変だった)。
