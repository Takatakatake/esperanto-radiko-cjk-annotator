...
def ne_entries():
    ...
    return out
APPS={'JP':(r"\Esperanto-Kanji-Converter-and-Ruby-Annotation-Tool",r"\エスペラント語根-日本語訳ルビ対応リスト.csv",'ja'),
...
def process(key, write):
    d,csvn,lang=APPS[key]; APPDIR=BASE+d; DATA=APPDIR+r"\Appの运行に使用する各类文件"; sp=DATA+STEM
